 ...
 */
function deactivate_blossom_recipe() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-blossom-recipe-deactivator.php';
	Blossom_Recipe_Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'activate_blossom_recipe' );
register_deactivation_hook( __FILE__, 'deactivate_blossom_recipe' );
 ...
 * @since    1.0.0
 */
function run_blossom_recipe() {

	$plugin = new Blossom_Recipe();
	$plugin->run();
